...
class TestTruncateThinking(unittest.TestCase):
    ...
    def test_removes_single_think_block(self):
        result = self.node.truncate(Text="Hello <think>deep reasoning</think> world")
        self.assertEqual(result[0], "Hello  world")
        self.assertEqual(result[1], "deep reasoning")

    def test_removes_multiple_think_blocks(self):
        result = self.node.truncate(Text="A<think>first</think>B<think>second</think>C")
    ...
    def test_multiline_think_content(self):
        result = self.node.truncate(Text="<think>line1\nline2\nline3</think>done")
